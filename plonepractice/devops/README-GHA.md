...
2. Go to your repository at [collective/plonepractice](https://github.com/collective/plonepractice).
3. Click on `Settings` at the top-right corner.
4. In the left sidebar, click on `Environments`.
5. Press `New environment`.
6. Name the environment `plonepractice.example.com` and hit `Configure environment`.
...
|-------------|--------------|-------------|
| DEPLOY_HOST | plonepractice.example.com | The hostname or IP address of your Docker Swarm manager. |
...
| Name     | Value |
|----------|-------|
| LIVE_ENV | plonepractice.example.com |
...
- [Backend Tests Workflow](https://github.com/collective/plonepractice/actions/workflows/backend.yml)
- [Frontend Tests Workflow](https://github.com/collective/plonepractice/actions/workflows/frontend.yml)

Upon successful completion of the tests, Docker images for the Backend (`ghcr.io/collective/plonepractice-backend`) and Frontend (`ghcr.io/collective/plonepractice-frontend`) will be available.

### Initiating Manual Deployment

1. Navigate to [Manual Deployment of plonepractice.example.com](https://github.com/collective/plonepractice/actions/workflows/manual-deploy.yml).
...
- Initiate a new deployment using the `devops/stacks/plonepractice.example.com.yml` stack.
