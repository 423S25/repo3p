...
DEPLOY_ENV=prod
DEPLOY_HOST=plonepractice.example.com
DEPLOY_PORT=22
DEPLOY_USER=plone
...
You need either a Ubuntu or Debian based system for plonepractice.example.com, enable SSH, and install a supported version of Python 3 on that system.
...
prod:
  hosts:
    plonepractice.example.com:
      ansible_user: root
      host: plonepractice
      hostname: plonepractice.example.com
```
...
Deploy the stack defined in `devops/stacks/plonepractice.example.com.yml` to the remote server with:
